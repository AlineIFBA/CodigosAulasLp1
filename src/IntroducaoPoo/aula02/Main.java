...
public class Main {
   public static void main(String[] args) {
      ...
      Aluno b= new Aluno("Maria"); //Chamando o construtor de 1 argumento com valor literal
      Aluno c= new Aluno(); //Chamando o construtor padrão
      
      Aluno e= new Aluno("Carla",457); //Chamando o construtor padrão

      a.menorMatricula(a,e);
      ...
      //Vamos modificar a matrícula do objeto a e depois imprimir os dados novamente:
        a.setMatricula(987); //Modificando a matrícula de "a" através do método "setMatricula"
        a.imprimirDados();
